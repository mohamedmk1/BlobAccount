#pragma checksum "C:\Tutos\C#\Pluralight\BlobAccount.WiredBrainCoffee\WiredBrainCoffee.AdminApp\View\AddCoffeeVideoDialog.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "4B8EE22596F44118749AB8CBD74ABB91"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IAddCoffeeVideoDialog_Bindings
        {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 1: // View\AddCoffeeVideoDialog.xaml line 1
                        ...
                        break;
                    case 2: // View\AddCoffeeVideoDialog.xaml line 24
            ...
            private void Update_ViewModel(global::WiredBrainCoffee.AdminApp.ViewModel.AddCoffeeVideoDialogViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_ViewModel_BlobTitle(obj.BlobTitle, phase);
                        this.Update_ViewModel_BlobDescription(obj.BlobDescription, phase);
                    }
                }
            }
            ...
            private void Update_ViewModel_BlobNameWithoutExtension(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\AddCoffeeVideoDialog.xaml line 26
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_TextBox_Text(this.obj3, obj, null);
                }
            }
            private void Update_ViewModel_BlobTitle(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\AddCoffeeVideoDialog.xaml line 29
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_TextBox_Text(this.obj4, obj, null);
                }
            }
            private void Update_ViewModel_BlobDescription(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\AddCoffeeVideoDialog.xaml line 30
            ...
            private void UpdateTwoWay_4_Text()
            {
                if (this.initialized)
                {
                    this.dataRoot.ViewModel.BlobTitle = this.obj4.Text;
                }
            }
            private void UpdateTwoWay_5_Text()
            {
                if (this.initialized)
                {
                    this.dataRoot.ViewModel.BlobDescription = this.obj5.Text;
                }
            }
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_ViewModel_BlobTitle(obj.BlobTitle, DATA_CHANGED);
                                bindings.Update_ViewModel_BlobDescription(obj.BlobDescription, DATA_CHANGED);
                            }
                        }
                        else
                        {
