#pragma checksum "C:\Tutos\C#\Pluralight\BlobAccount.WiredBrainCoffee\WiredBrainCoffee.AdminApp\View\CoffeeVideoView.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "0CE2EC387079A4D81E59C9144D45BE6A"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ICoffeeVideoView_Bindings
        {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 6: // View\CoffeeVideoView.xaml line 53
                        ...
                        {
                            this.dataRoot.ViewModel.UpdateMetadataAsync();
                        };
                        break;
                    case 7: // View\CoffeeVideoView.xaml line 55
                        this.obj7 = (global::Windows.UI.Xaml.Controls.Button)target;
                        ((global::Windows.UI.Xaml.Controls.Button)target).Click += (global::System.Object sender, global::Windows.UI.Xaml.RoutedEventArgs e) =>
                        {
                            this.dataRoot.ViewModel.ReloadMetadataAsync();
                        };
                        break;
                    case 8: // View\CoffeeVideoView.xaml line 41
                        this.obj8 = (global::Windows.UI.Xaml.Controls.MediaElement)target;
                        break;
                    case 9: // View\CoffeeVideoView.xaml line 31
                        ...
                        {
                            this.dataRoot.ViewModel.DownloadVideoToFileAsync();
                        };
                        break;
                    case 10: // View\CoffeeVideoView.xaml line 33
                        this.obj10 = (global::Windows.UI.Xaml.Controls.MenuFlyoutItem)target;
                        ((global::Windows.UI.Xaml.Controls.MenuFlyoutItem)target).Click += (global::System.Object sender, global::Windows.UI.Xaml.RoutedEventArgs e) =>
                        {
                            this.dataRoot.ViewModel.DeleteVideoAsync();
                        };
                        break;
                    default:
                        break;
            ...
            private void Update_ViewModel(global::WiredBrainCoffee.AdminApp.ViewModel.CoffeeVideoViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_ViewModel_IsMetadataChanged(obj.IsMetadataChanged, phase);
                    }
                }
            }
            ...
            private void Update_ViewModel_BlobUri(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\CoffeeVideoView.xaml line 23
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_TextBox_Text(this.obj3, obj, null);
                    // View\CoffeeVideoView.xaml line 41
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_MediaElement_Source(this.obj8, (global::System.Uri) global::Windows.UI.Xaml.Markup.XamlBindingHelper.ConvertValue(typeof(global::System.Uri), obj), null);
                }
            }
            private void Update_ViewModel_Title(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\CoffeeVideoView.xaml line 58
            ...
            private void Update_ViewModel_Description(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\CoffeeVideoView.xaml line 59
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_TextBox_Text(this.obj5, obj, null);
                }
            }
            private void Update_ViewModel_IsMetadataChanged(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // View\CoffeeVideoView.xaml line 53
            ...
            private void UpdateTwoWay_4_Text()
            {
                if (this.initialized)
                {
                    this.dataRoot.ViewModel.Title = this.obj4.Text;
                }
            }
            private void UpdateTwoWay_5_Text()
            {
                if (this.initialized)
                {
                    this.dataRoot.ViewModel.Description = this.obj5.Text;
                }
            }
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_ViewModel_IsMetadataChanged(obj.IsMetadataChanged, DATA_CHANGED);
                            }
                        }
                        else
                        {
